...
class PagesSeeder extends Seeder
{
    ...
    private function homeContent(): array
    {
        return [
            ...
            'affordable' => [
                'eyebrow' => 'Today\'s records build a strong business — for the next ten years.',
                'title' => 'You handle today\'s queue. SkelApp handles the next decade.',
                'subtitle' => 'Today\'s records build a strong business — for the next ten years.',
                'cards' => [
                    [
                        'variant' => 'light',
    ...
    private function posContent(): array
    {
        ...
        return [
            ...
            'hero' => [
                ...
                'subtitle' => "Ring up sales in seconds, record every payment however it's made, and keep selling when the power drops — a POS system your team learns in minutes.",
            ...
            'detail' => [
                'title' => 'What SkelApp can do',
                'subtitle' => 'Cashflow, inventory, online orders, reports and team control — one retail system, built in Skel style for real trading days.',
            ],
            'feature_groups' => [
                [
                    'tab' => 'Cashflow',
                    ...
                    'image' => 'assets/CASHFLOW.png',
                    'items_text' => "Multi-device | Owners, attendants and managers can all work from the device that fits them best while staying inside one synced SkelApp account. | assets/card.webp\nMulti-location | Run one branch or many, then split sales, stock and staff activity by location without losing the full business view. | assets/CHECKOUTPOS.png\nSales ledger | Every shilling in and out is captured the moment it happens, so the day never needs rebuilding from memory. | assets/CASHFLOW.png\nProfit view | Open the dashboard and understand what sold, what moved out and where the money stands right now. | assets/DASHBOARD.png\nDebts & credits | Track both sides of the relationship, from customer balances to supplier credits and the payment accounts that keep them organised. | assets/crm.webp\nPayment accounts | Split cash, bank, card and mobile money into the right accounts so reconciliation is clean at closing time. | assets/paymentmethod.png",
                ],
                [
                    'tab' => 'Inventory',
                    ...
                    'image' => 'assets/STOCKLIST.png',
                    'items_text' => "Advanced stock | Keep day-to-day stock handling inside one workflow instead of spreading it across notebooks, spreadsheets and memory. | assets/STOCKLIST.png\nBatch tracking | Track stock by batch so you know what came in, what sold first and what needs acting on next. | assets/hardware.webp\nTransfers | Move items from one branch to another with a clear record of where stock left, where it landed and who handled it. | assets/grocery.webp\nAdjustments | Correct counts, process returns and keep the stock ledger accurate without hiding what changed. | assets/kitchenware.webp\nStock analysis | Stock analysis helps you spot the products that are moving fastest, running low or nearing expiry before they become a problem. | assets/autospare.webp\nReturns | Handle customer and supplier returns without breaking stock accuracy or losing the paper trail behind each change. | assets/Pos System 04.png",
                ],
                [
                    'tab' => 'Reports',
            ...
            'features' => [
                ['name' => 'Lightning-fast checkout', 'body' => 'Search, scan or tap a favourite, take payment and move on — queues keep moving even at your busiest.', 'image' => 'assets/CHECKOUTPOS.png'],
                ['name' => 'Every payment, recorded', 'body' => 'Cash, mobile money, bank or card — mark how the customer paid, split payments included, reconciled by payment account.', 'image' => 'assets/card.webp'],
                ['name' => 'Keeps selling offline', 'body' => "Power cut or network gone, the counter keeps working. Everything syncs when you're back.", 'image' => 'assets/CASHFLOW.png'],
                ['name' => 'Receipts your way', 'body' => 'Print, SMS or WhatsApp the receipt — or skip it. The sale is recorded either way.', 'image' => 'assets/Pos System 04.png'],
                ['name' => 'Live stock as you sell', 'body' => 'Every sale updates stock instantly, with low-stock alerts before the shelf runs empty.', 'image' => 'assets/STOCKLIST.png'],
                ['name' => 'Know your day at a glance', 'body' => 'Sales, expenses and profit for the day — one screen before you lock up.', 'image' => 'assets/DASHBOARD.png'],
            ],
            'offline' => [
            ...
            'sync' => [
                'title' => 'The sale is just the start.',
                'subtitle' => 'After the customer walks out, SkelApp keeps working — every sale, every device, every branch, one live picture.',
                'cards' => [
            ...
            'integrations' => [
                ...
                'title' => 'Plays well with your accountant.',
                'body' => 'Your sales, stock and receipts flow to the tools you already use.',
                'more_label' => 'More Integrations',
                'more_url' => '/integrations',
                'logos' => [
            ...
            // Shared with the hardware-product & retailer pages (not rendered on this page).
            'ecosystem' => $shared['ecosystem'] ?? [],
            'testimonial' => array_merge($shared['testimonial'] ?? [], [
                'section_title' => 'What real business owners say about SkelApp',
                'section_subtitle' => 'Shop owners across Tanzania on what changed at their counters — in their own words.',
                'stats' => [
                    ['value' => '5 min', 'label' => 'To set up'],
                    ['value' => '3 shops', 'label' => 'One dashboard'],
                    ['value' => 'Sells through', 'label' => 'every power cut'],
                ],
            ]),
            'testimonials' => [
                [
            ...
            'pricing' => [
                ...
                // price_was is not shown on this page, but is shared with the hardware-product page's pricing card.
                'price_was' => '1,000 TZS',
            ...
            'faq' => [
                'title' => 'Questions shop owners actually ask',
                'title_accent' => '',
                'subtitle' => 'POS FAQ',
                'read_more_label' => 'Read more',
                'items' => [
                    ['q' => 'What is SkelApp POS?', 'a' => 'SkelApp is a point of sale system built for small businesses in Tanzania. It runs on your phone, a tablet, or the Skel Register, and handles checkout, payments, stock, madeni and daily reports in one app.'],
                    ['q' => 'Does SkelApp work offline?', 'a' => "Yes — SkelApp is an offline-first POS. When power or network drops, you keep selling on the device, and everything syncs the moment you're back online."],
                    ['q' => 'Which payments can I record?', 'a' => 'Cash, mobile money, bank transfers and cards — record every payment however your customers pay, with payment accounts keeping each method reconciled.'],
                    ['q' => 'Do I need to buy hardware?', 'a' => 'No. SkelApp starts on the phone already in your pocket. Add a receipt printer or the Skel Register whenever your counter is ready for one.'],
                    ['q' => 'How much does SkelApp cost?', 'a' => 'TZS 15,000 per month — about 500 shillings a day — or TZS 150,000 per year with two months free. Every feature included, no tiers.'],
                    ['q' => 'Can I run more than one shop?', 'a' => "Yes. Every branch and staff account is included — you see every location's sales, stock and staff activity from one dashboard, and you can transfer stock between locations."],
                    ['q' => 'Which devices does SkelApp run on?', 'a' => 'iOS, Android and any web browser — phone, tablet, computer or the Skel Register, all synced to the same account.'],
                    ['q' => 'Does SkelApp work with accounting software?', 'a' => 'Yes — SkelApp integrates with Zoho Books, QuickBooks, Xero and Sage, plus bulk SMS providers and WhatsApp for receipts and customer messages.'],
                ],
            ],
        ];
    }
    ...
    private function whyContent(): array
    {
        return [
            ...
            'hero' => [
                ...
                'title' => 'About SkelApp<br>and why we built',
                ...
                // Hero photo now mirrors the home page hero (home.hero.background_image_desktop).
            ...
            'build' => [
                'title' => 'Why we build SkelApp',
                'subtitle' => 'A few beliefs shaped everything — from the first line of code to the team that shows up at your shop.',
                'reasons' => [
            ...
            'gallery' => [
                ...
                'subtitle' => 'A look inside the shops we serve — and the people who make every day worth showing up for.',
                'image_main' => 'assets/client.webp',
                'image_a' => 'assets/techshop.webp',
                'image_b' => 'assets/grocery.webp',
            ],
            'people' => [
                'title' => "People who\nshow up",
    ...
    private function pricingContent(): array
    {
        return [
            ...
            'hero' => [
                'image' => 'assets/HeroImage.webp',
                'eyebrow' => 'SkelApp pricing',
                'title' => "The point of sale built for Tanzania.\nPriced so any shop can start.",
                'benefits' => [
                    ['icon' => 'tag', 'text' => 'Plans start at free'],
                    ['icon' => 'bolt', 'text' => 'Keeps selling through power cuts'],
                    ['icon' => 'setup', 'text' => 'Setup & staff training included'],
                    ['icon' => 'support', 'text' => '24/7 support included'],
                ],
                'alt_prefix' => 'Need the hardware too?',
                'alt_label' => 'Explore SkelApp devices',
                'alt_url' => '/hardware',
            ],
            'billing' => [
            ...
            'tiers_features_heading' => 'What you get',
            'tiers' => [
                [
                    'name' => 'WingaMode',
                    'description' => 'Essential features for businesses managed by a single owner',
                    'price' => 'Free',
                    'price_monthly' => '',
                    'price_suffix' => '',
                    ...
                    'features' => implode("\n", [
                        '1 User',
                        '10 POS transactions/month',
                        '10 Online Store orders/month',
                        '10 Purchase Orders & Bills/month',
                ...
                [
                    'name' => 'Build Your Own',
                    'description' => 'For multi-branch operations that need SkelApp shaped around how they trade',
                    'price' => 'Custom pricing',
                    'price_monthly' => '',
                    'price_suffix' => '',
                    'price_note' => 'Scoped to your branches and volume',
                    'price_note_monthly' => '',
